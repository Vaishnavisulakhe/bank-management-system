...
session_start();
    ...
    if(mysqli_connect_errno())
    {
        ...
        echo "<a href='bank_home.php'>Go Back</a>";
        exit();
    }
    $query="select * from customers";
    $result=mysqli_query($con,$query);
    echo "<table class='table table-striped'>";
    echo "<tr><th>Mobile</th><th>Name</th><th>Age</th><th>Address</th></tr>";
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        echo "<tr><td>$mobileno</td><td>$name</td><td>$age</td><td>$address</td></tr>";
